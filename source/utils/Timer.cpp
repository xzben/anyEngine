...
time_t Timer::get_time_stamp_sec() { return get_time_stamp_microsec() / 1000000; }

time_t Timer::get_time_stamp_millisec() { return get_time_stamp_microsec() / 1000; }

time_t Timer::get_time_stamp_microsec() {
    std::chrono::time_point time_point_now = std::chrono::system_clock::now();  // ��ȡ��ǰʱ���
    ...
    time_t microseconds_since_epoch =
        std::chrono::duration_cast<std::chrono::microseconds>(duration_since_epoch)
            .count();  // ��ʱ��ת��Ϊ΢����
